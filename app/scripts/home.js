class Home {
  ...
  constructor() {
    ...
    this.itemTourist = '[' +
      ...
      '    "image": "https://www.welcomeargentina.com/paseos/recorrido_balcarce/balcarce-city-tour-1.jpg"' +
      '  },' +
      '  {' +
      '    "userId": 1,' +
      '    "id": 2,' +
      ...
      '    "image": "https://www.welcomeargentina.com/paseos/postre_balcarce/postre-balcarce-1.jpg"' +
      '  },' +
      '  {' +
      '    "userId": 1,' +
      '    "id": 3,' +
