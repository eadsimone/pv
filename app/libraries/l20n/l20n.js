...
//begin-The following code is not in the original library
//function to check if the browser has cookie enable
...
//end-The following code is not in the original library

{
  (function () {
    ...
    var fetchResource = function fetchResource(res, lang) {
      ...
      var zhhans = ["zh", "zh-TW", "zh-CN", "zh-HK", "zh-SG"];
      var navigatorLang = navigator.language;

      if (!(checkCookie())) {
        if (zhhans.indexOf(navigatorLang) > -1) {
          //In the array!
          lang= 'zh-Hant';
         }
      }
